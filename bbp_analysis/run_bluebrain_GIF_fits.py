...
from BlueBrain import fit_bluebrain
from BlueBrain.SpikeTrainComparator import SpikeTrainComparator
...
root_path = './BlueBrain/article_4_data/grouped_ephys/'
figure_path = './BlueBrain/results/figures/fits/gif_rect_basis/'
model_path = './BlueBrain/results/models/basic/'
expm_path = './BlueBrain/results/experiments/'
...
for nr in range(num_of_animals):
    fitted = fit_bluebrain.run(nr, root_path, unwanted_sessions)
    if not fitted:
        continue
    else:
...
#==============================================================================
    ...
    plt.savefig(figure_path + str(expm.name) + '_fit.png', dpi=120)
    plt.close(fig)
