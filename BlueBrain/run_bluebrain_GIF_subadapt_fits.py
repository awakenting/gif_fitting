...
for nr in [4]:
    fitted = fit_bluebrain_subadapt.run(nr, root_path, unwanted_sessions)
    if not fitted:
        continue
    else:
...
#  Save figure
#==============================================================================
    plt.savefig('/home/andrej/Documents/Code/BlueBrain/results/figures/fits/subadapt/' + str(expm.name) + '_fit_subadapt.png', dpi=120)
    plt.close(fig)
