...
class GIF_pow(ThresholdModel) :
    ...
    def simulateSpikingResponse(self, I, dt):
        ...
        """
        Simulate the spiking response of the GIF_pow model to an input current I (nA) with time step dt.
    ...
    def simulateDeterministic_forceSpikes(self, I, V0, spks):
        ...
        """
        Simulate the subthresohld response of the GIF_pow model to an input current I (nA) with time step dt.
    ...
    def fit(self, experiment, DT_beforeSpike = 5.0):
        ...
        """
        Fit the GIF_pow model on experimental data.
    ...
    def fitSubthresholdDynamics(self, experiment, DT_beforeSpike=5.0):
        ...
        print ("\nGIF_pow MODEL - Fit subthreshold dynamics..." )
    ...
    def fitStaticThreshold(self, experiment):
        ...
        print ("\nGIF_pow MODEL - Fit static threshold...\n")
    ...
    def fitThresholdDynamics(self, experiment):
        ...
        print ("\nGIF_pow MODEL - Fit dynamic threshold...\n")
    ...
    def printParameters(self):
        ...
        print ("\n-------------------------")       
        print ("GIF_pow model parameters:")
        print ("-------------------------")
    ...
    @classmethod
    def compareModels(cls, GIF_pows, labels=None):

        """
        Given a list of GIF_pow models, GIF_pows, the function produce a plot in which the model parameters are compared.
        """

        # PRINT PARAMETERS        

        print ("\n#####################################")
        print ("GIF_pow model comparison")
        print ("#####################################\n")
        
        cnt = 0
        for GIF_pow in GIF_pows :
            
            print ("Model: " + labels[cnt])          
            GIF_pow.printParameters()
            cnt+=1
        ...
        colors = plt.cm.jet( np.linspace(0.7, 1.0, len(GIF_pows) ) )   
        ...
        for GIF_pow in GIF_pows :
            ...
            K = 1./GIF_pow.C*np.exp(-K_support/(GIF_pow.C/GIF_pow.gl))     
        ...
        for GIF_pow in GIF_pows :
            ...
            (eta_support, eta) = GIF_pow.eta.getInterpolatedFilter(0.1)         
        ...
        for GIF_pow in GIF_pows :
            ...
            V_support = np.linspace(GIF_pow.Vt_star-5*GIF_pow.DV,GIF_pow.Vt_star+10*GIF_pow.DV, 1000) 
            escape_rate = GIF_pow.lambda0*np.exp((V_support-GIF_pow.Vt_star)/GIF_pow.DV)                
        ...
        for GIF_pow in GIF_pows :
            ...
            (gamma_support, gamma) = GIF_pow.gamma.getInterpolatedFilter(0.1)         
    ...
    @classmethod
    def plotAverageModel(cls, GIF_pows):
        ...
        for GIF_pow in GIF_pows :
            ...
            (K_support, K) = GIF_pow.eta.getInterpolatedFilter(0.1)      
        ...
        for GIF_pow in GIF_pows :
            ...
            (K_support, K) = GIF_pow.gamma.getInterpolatedFilter(0.1)      
