...
class TwoCompGIF(ThresholdModel) :
    ...
    def simulateSpikingResponse(self, I, dt):
        ...
        """
        Simulate the spiking response of the TwoCompGIF model to an input current I (nA) with time step dt.
    ...
    def simulateDeterministic_forceSpikes(self, I, V0, spks):
        ...
        """
        Simulate the subthresohld response of the TwoCompGIF model to an input current I (nA) with time step dt.
    ...
    def fit(self, experiment, DT_beforeSpike = 5.0):
        ...
        """
        Fit the TwoCompGIF model on experimental data.
    ...
    def fitSubthresholdDynamics(self, experiment, DT_beforeSpike=5.0):
        ...
        print ("\nTwoCompGIF MODEL - Fit subthreshold dynamics..." )
    ...
    def fitStaticThreshold(self, experiment):
        ...
        print ("\nTwoCompGIF MODEL - Fit static threshold...\n")
    ...
    def fitThresholdDynamics(self, experiment):
        ...
        print ("\nTwoCompGIF MODEL - Fit dynamic threshold...\n")
    ...
    def printParameters(self):
        ...
        print ("\n-------------------------")       
        print ("TwoCompGIF model parameters:")
        print ("-------------------------")
    ...
    @classmethod
    def compareModels(cls, TwoCompGIFs, labels=None):

        """
        Given a list of TwoCompGIF models, TwoCompGIFs, the function produce a plot in which the model parameters are compared.
        """

        # PRINT PARAMETERS        

        print ("\n#####################################")
        print ("TwoCompGIF model comparison")
        print ("#####################################\n")
        
        cnt = 0
        for TwoCompGIF in TwoCompGIFs :
            
            print ("Model: " + labels[cnt])          
            TwoCompGIF.printParameters()
            cnt+=1
        ...
        colors = plt.cm.jet( np.linspace(0.7, 1.0, len(TwoCompGIFs) ) )   
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            K = 1./TwoCompGIF.C*np.exp(-K_support/(TwoCompGIF.C/TwoCompGIF.gl))     
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            (eta_support, eta) = TwoCompGIF.eta.getInterpolatedFilter(0.1)         
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            V_support = np.linspace(TwoCompGIF.Vt_star-5*TwoCompGIF.DV,TwoCompGIF.Vt_star+10*TwoCompGIF.DV, 1000) 
            escape_rate = TwoCompGIF.lambda0*np.exp((V_support-TwoCompGIF.Vt_star)/TwoCompGIF.DV)                
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            (gamma_support, gamma) = TwoCompGIF.gamma.getInterpolatedFilter(0.1)         
    ...
    @classmethod
    def plotAverageModel(cls, TwoCompGIFs):
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            (K_support, K) = TwoCompGIF.eta.getInterpolatedFilter(0.1)      
        ...
        for TwoCompGIF in TwoCompGIFs :
            ...
            (K_support, K) = TwoCompGIF.gamma.getInterpolatedFilter(0.1)      
