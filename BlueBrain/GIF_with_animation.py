...
class GIF_with_animation(ThresholdModel) :
    ...
    def fitStaticThreshold(self, experiment):
        ...
        beta_opt = self.maximizeLikelihood(experiment, beta0_staticThreshold, self.buildXmatrix_staticThreshold, do_animation=False) 
    ...
    def fitThresholdDynamics(self, experiment):
        ...
        beta_opt = self.maximizeLikelihood(experiment, beta0_dynamicThreshold, self.buildXmatrix_dynamicThreshold, do_animation=True)
