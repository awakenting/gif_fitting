...
myGIF.fit_cython(myExp, DT_beforeSpike=5.0)
...
#I_OU = Tools_py3.generateOUprocess_sinMean(f=1.0, T=5000.0, tau=3.0, mu=0.3, delta_mu=0.5, sigma=0.1, dt=0.1)
