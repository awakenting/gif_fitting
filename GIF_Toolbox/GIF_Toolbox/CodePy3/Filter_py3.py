...
class Filter_py3 :
    ...
    def getInterpolatedFilter_expFit(self, dt) :
        ...
        if self.expfit_falg :
            ...
            F_exp = Filter_py3.multiExpEval(t, self.b0, self.tau0)
    ...
    def convolution_SpikeTrain(self, spks, T, dt):
        ...
        spks_i = Tools_py3.timeToIndex(spks, dt)        
        (t,F) = self.getInterpolatedFilter(dt)
        F_length = len(F)
    ...
    def plot(self, dt=0.05) :
        ...
        if self.expfit_falg :
            F_fit = Filter_py3.multiExpEval(t, self.b0, self.tau0)
    ...
    def fitSumOfExponentials(self, dim, bs, taus, ROI=None, dt=0.1) :
        ...
        plsq = leastsq(Filter_py3.multiExpResiduals, p0, args=(t_fit,F_fit,dim), maxfev=100000,ftol=0.00000001)
        
        p_opt = plsq[0]
        bs_opt = p_opt[:dim]
        taus_opt = p_opt[dim:]
        
        F_exp = Filter_py3.multiExpEval(t, bs_opt, taus_opt)
    ...
    def multiExpResiduals(cls, p, x, y, d):
        ...
        return (y - Filter_py3.multiExpEval(x, bs, taus)) 
