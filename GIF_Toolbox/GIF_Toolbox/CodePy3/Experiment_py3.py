...
from SpikeTrainComparator_py3 import *
from SpikingModel_py3 import *
from Trace_py3 import *


class Experiment_py3 :
    ...
    def setAECTrace(self, V, V_units, I, I_units, T, FILETYPE='Igor'):
        ...
        print ("Set AEC trace...")
        trace_tmp = Trace_py3( V, V_units, I, I_units, T, self.dt, FILETYPE=FILETYPE)
    ...
    def predictSpikes(self, spiking_model, nb_rep=500):
        ...
        prediction = SpikeTrainComparator_py3(T_test, all_spks_times_testset, all_spks_times_prediction)
