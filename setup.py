...
extensions = [Extension("fitgif.cython_helpers", sources=["fitgif/cython_helpers"+ext], include_dirs=[np.get_include(), "."])]
...
setup(
        name='gif_fitting',
        version='0.5',
        packages=['fitgif', 'bbp_analysis'],
        ext_modules=extensions,
        url='https://github.com/awakenting/gif_fitting',
        license='GPL',
        author='awakenting',
        author_email='an.warkentin@web.de',
        description='bluebrain project data analysis, including fitting of Generalized Integrate&Fire models'
)
"""
# Setup script adapted from the cython template from
# https://github.com/jakevdp/cython_template which is
